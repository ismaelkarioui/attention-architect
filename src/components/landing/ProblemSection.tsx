    ...
    <section className="px-6 lg:px-12 max-w-7xl mx-auto py-[80px]">
      <div className="grid lg:grid-cols-12 gap-16">
        <motion.div
          ...
          <h2 className="text-4xl md:text-5xl font-serif font-bold leading-tight">Vous payez une fortune pour de <span className="italic text-gradient-gold">l'attention qui vous échappe</span> en une fraction de seconde
          </h2>
        </motion.div>
        ...
        <motion.div
          ...
          <div className="space-y-6 border-l border-border pl-8">
            ...
            {
              stat: "8 secondes",
              label: "C'est la durée d'attention moyenne d'un humain en 2026,",
              detail: "soit moins que celle d'un poisson rouge. Si l'accroche de votre VSL ne stoppe pas le scroll, c'est comme si vous n'existiez pas."
            },
            {
              stat: "73%",
